...
Now, download the image "Frank_Zappa.png" from the Files/Data. Identify the location of this image and use this as the *directory* variable below. Importantly, your directory and mine will be different.

Let's load the image, convert it to an array and plot the image in R. This can be done with the following code

```{r, echo = TRUE}
directory <- "Frank_Zappa.png" 
